...
### 1. GET FILES from FLASK SERVER to HADOOP SERVER
    flask_to_hadoop = SSHOperator(
        ...
        ssh_hook = hook_flask,
        command = 'scp -r /home/ubuntu/projects/Bigdata_busan/web/project/dogma/static/images/bad/* root@35.75.77.128:/home/ubuntu/get_badimg'
    )
...
### 2. EMPTY OUT DIRECTORY in FLASK SERVER
    empty_out_flask = SSHOperator(
        ...
        ssh_hook = hook_flask,
        command = 'sudo rm -r /home/ubuntu/projects/Bigdata_busan/web/project/dogma/static/images/bad/*'
    )
